...
public class C15_PostRequestNestedMap extends BookerBaseUrl {
    ...
    public void nestedMapTest(){
        ...
        Map<String , String> bookingDatesMap = BookerTestData.bookingDatesMethod("2023-03-07" ,"2024-09-25"); // To prepare test method here is not recommended . We will prepare testData

        System.out.println("bookingDatesMap = " + bookingDatesMap);

        //Second we need to prepare outer json as map
        ...
        //Since all the values inside Object container,
        // we need to cast them when we need to use them as their original data types. Like Map, int, String..
