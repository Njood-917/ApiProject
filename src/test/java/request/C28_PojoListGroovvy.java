...
public class C28_PojoListGroovvy extends JsonPlaceHolderBaseUrl {
    @Test
    void pojoListTest() throws JsonProcessingException {
        ...
        //Do assertion
        Object actualDataObject = response.jsonPath().getList("findAll{it.title=='et porro tempora'}").getFirst();//filter by groovy
